...
<ul>
  ...
  <ul>
    ...
    <ul>
      <li>The percentage of patients that have a stroke and ever being married is <b>5%</b> and percentage patients that have a stroke and never been married is <b>2.5%</b>. From the data being ever married has a higher influence to having a stroke
      </li>
    ...
    <li>A bar plot showing the relationship of strokes and average glucose levels</li>
    <ul>
    ...
    <li>A bar plot showing the relationship of strokes and bmi levels</li>
    <ul>
